...
function jumpToQuestion95() {
    if (questions.length > 94) {
        currentQuestionIndex = 94;
        renderQuestion();
    } else {
        console.error('O simulado não tem 95 questões.');
    }
}
...
// ADIÇÃO IMPORTANTE: Event listener para o botão de finalizar
...
// Tornando as funções acessíveis no console para facilitar o teste
window.jumpToQuestion95 = jumpToQuestion95;
